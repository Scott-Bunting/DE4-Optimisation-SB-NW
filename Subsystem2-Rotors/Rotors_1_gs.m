...
function [c,ceq] = constraintFunctionEnd(x, rhoMaterial, sigmaMaterial, E)
    ...
    thrust = 2*numberRotors*numberBlades*sin(theta)*omega*rhoAir*g*(x(3)^2 - x(4)^2)*x(1);
